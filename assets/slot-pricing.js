...
export function mountSlotPricing(root, config, lang = 'en') {
 ...
 <output aria-live="polite"></output><p data-slot-credits></p><p>${w.included}</p><a href="https://clientrelay.tech/app/?lang=${encodeURIComponent(lang)}">${w.continue}</a></section></div>
